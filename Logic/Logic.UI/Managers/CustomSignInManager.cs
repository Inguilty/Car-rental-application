...
namespace Logic.UI.Managers
{
    ...
    /// </summary>
    public class CustomSignInManager : SignInManager<ApplicationUser, int>
    {
        #region constructors and destructors

        private CustomSignInManager(CustomUserManager userManager, IAuthenticationManager authenticationManager) 
